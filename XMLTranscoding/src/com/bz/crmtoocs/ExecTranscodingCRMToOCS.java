...
public class ExecTranscodingCRMToOCS {
	 ...
	 */
	public ExecTranscodingCRMToOCS() {
		super();
		/*
	...
	public static String execXmlString(String xmlString, String rulesStr) {
		 ...
		 */
		RegexMatcherCRMToOCS javaRegex = new RegexMatcherCRMToOCS(rulesStr);
		...
		try {
			...
			if (javaRegex.matchCommaSep()) {
				...
				ExecTranscodingCRMToOCS setUnknownXMLStructure = new ExecTranscodingCRMToOCS();
